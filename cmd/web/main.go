...
func main() {
	...
	positions.POST("/ajax_get_positions", positionController.AjaxGetPositions)
	positions.POST("/ajax_create_position", positionController.AjaxCreatePosition)
	positions.POST("/ajax_close_position", positionController.AjaxClosePosition)
	positions.POST("/ajax_delete_position", positionController.AjaxDeletePosition)

	positionDetails := r.Group("/positions_calc/position")
	positionDetails.GET("/", positionController.PositionPage)
	positionDetails.POST("/ajax_get_position", positionController.AjaxGetPosition)
	positionDetails.POST("/ajax_edit_position", positionController.AjaxEditPosition)
	positionDetails.POST("/ajax_get_trans", positionController.AjaxGetTransactions)
	positionDetails.POST("/ajax_create_trans", positionController.AjaxCreateTransaction)
	positionDetails.POST("/ajax_edit_trans", positionController.AjaxEditTransaction)
	positionDetails.POST("/ajax_upload_trans_csv", positionController.AjaxUploadTransactionCSV)
	positionDetails.POST("/ajax_prepare_exchange_import", positionController.AjaxPrepareExchangeImport)
	positionDetails.POST("/ajax_preview_exchange_import", positionController.AjaxPreviewExchangeImport)
	positionDetails.POST("/ajax_import_exchange_transactions", positionController.AjaxImportExchangeTransactions)
	positionDetails.POST("/ajax_delete_trans", positionController.AjaxDeleteTransaction)
	positionDetails.POST("/ajax_kucoin_price", positionController.AjaxKucoinPrice)
	positionDetails.POST("/ajax_kucoin_token", positionController.AjaxKucoinToken)
