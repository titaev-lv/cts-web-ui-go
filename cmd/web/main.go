...
func main() {
	...
	positionDetails.POST("/ajax_prepare_exchange_import.php", positionController.AjaxPrepareExchangeImport)
	positionDetails.POST("/ajax_preview_exchange_import.php", positionController.AjaxPreviewExchangeImport)
	positionDetails.POST("/ajax_import_exchange_transactions.php", positionController.AjaxImportExchangeTransactions)
